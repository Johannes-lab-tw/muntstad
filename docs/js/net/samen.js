...
export function createSamen(game) {
  ...
  for (const k of ['pos', 'world', 'stoke', 'steal', 'emote', 'boe', 'sleep', 'down', 'up', 'wake', 'fluit', 'schiet', 'buit', 'bump', 'baasklaar', 'plan']) relay.on(k, (d, from) => emit(k, d, from));   // V10.1: samen vechten
